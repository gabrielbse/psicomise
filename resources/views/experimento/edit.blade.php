...
@endif
{!! Form::model($experimento, ['method' => 'PATCH','route' => ['experimento.update', $experimento->id]]) !!}
<br>
            ...
            <div class=" col-md-8">
              ...
              <div class="col-sm-12 col-md-4">
               ...
               <div class="col-sm-12 col-md-8">
                <div class="form-group">
                    <strong>Nome do Farmaco (*Se utilizar farmaco):</strong>
                    {!! Form::text('nome_farmaco', null, array('placeholder' => 'Digite o nome do farmaco','class' => 'form-control')) !!}
                </div>
            </div>
              <div class="col-sm-12 col-md-4">
                <div class="form-group">
                    <strong>Dose do Farmaco(*Se utilizar farmaco):</strong>
             ...
             <div class="col-sm-12 col-md-4">
                ...
                <div class="col-sm-12 col-md-4">
                 ...
                 <div class="col-sm-12 col-md-4">
                   <div class="form-group">
                     <strong>via_de_admininistracao</strong>
